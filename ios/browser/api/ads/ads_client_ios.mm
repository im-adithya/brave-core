...
void NativeAdsClient::UrlRequest(ads::UrlRequestPtr url_request,
...
void NativeAdsClient::Log(const char* file,
                          const int line,
...
void NativeAdsClient::RunDBTransaction(ads::DBTransactionPtr transaction,
...
void NativeAdsClient::SetBooleanPref(const std::string& path,
                                     const bool value) {
...
void NativeAdsClient::SetDoublePref(const std::string& path,
                                    const double value) {
...
void NativeAdsClient::SetStringPref(const std::string& path,
                                    const std::string& value) {
...
void NativeAdsClient::SetInt64Pref(const std::string& path,
                                   const int64_t value) {
...
void NativeAdsClient::SetUint64Pref(const std::string& path,
...
void NativeAdsClient::RecordP2AEvent(const std::string& name,
